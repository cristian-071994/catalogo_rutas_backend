...
import { Mail, AlertCircle, Truck, BarChart3, MapPin } from 'lucide-react';
...
export default function LoginPage() {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-blue-50 via-white to-blue-50 flex items-center justify-center">
      <div className="w-full h-full px-8 sm:px-12 lg:px-20 xl:px-32 py-8">
        <div className="grid lg:grid-cols-2 gap-12 xl:gap-20 items-center h-full max-w-screen-2xl mx-auto">
          {/* Left Side - Branding */}
