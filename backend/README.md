...
```bash
# Asegúrate de estar en catalogo_rutas_backend/ (raíz)
.\start_backend.ps1  # Windows - Ejecuta todo automáticamente
```

**Opción B - Manual**:
```bash
# Desde la raíz (catalogo_rutas_backend/)
.\venv\Scripts\Activate.ps1  # Activar venv
cd backend                    # Ir a backend/
